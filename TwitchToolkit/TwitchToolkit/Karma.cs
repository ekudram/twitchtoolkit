...
{
	/// <summary>
	/// Handles karma calculations and transformations for viewers and events
	/// </summary>
	public static class Karma
	{
		...
		public static int CalculateNewKarma(int karma, KarmaType karmatype, int calculatedprice = 0)
		{
            ...
            ToolkitLogger.Debug($"Calculating new karma with {karma}, and karma type {karmatype} for {calculatedprice} with curve {CalculateForCurve()} tier {tier}");
			double newkarma = 0.0;
			int maxkarma = 0;
