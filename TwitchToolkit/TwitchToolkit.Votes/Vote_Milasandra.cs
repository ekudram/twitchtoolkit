...
public class Vote_Milasandra : VoteIncidentDef
{
	...
	public Vote_Milasandra(Dictionary<int, IncidentDef> incidents, StorytellerComp source, IncidentParms parms = null, string title = null)
		: base(incidents, source, parms)
	{
		pack = DefDatabase<StorytellerPack>.GetNamed("Milasandra", true);
		base.title = title;
	}
